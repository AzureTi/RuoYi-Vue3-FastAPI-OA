/*
 ...
 Source Server         : LH_RUOYI
 Source Server Type    : MySQL
 Source Server Version : 80045 (8.0.45)
 Source Host           : localhost:3306
 Source Schema         : ruoyi-fastapi

 Target Server Type    : MySQL
 Target Server Version : 80045 (8.0.45)
 File Encoding         : 65001

 Date: 14/04/2026 07:17:17
*/
...
CREATE TABLE `ai_chat_config`  (
  ...
  `add_history_to_context` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '是否添加历史记录(0是, 1否)',
  ...
  `metrics_default_visible` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '默认显示指标(0是, 1否)',
  `vision_enabled` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '1' COMMENT '是否开启视觉(0是, 1否)',
...
CREATE TABLE `ai_models`  (
  ...
  `provider` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '提供商',
  ...
  `base_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'Base URL',
  `model_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模型类型',
  `max_tokens` int NULL DEFAULT NULL COMMENT '最大输出token',
  `temperature` float NULL DEFAULT NULL COMMENT '默认温度',
  `support_reasoning` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'N' COMMENT '是否支持推理',
  `support_images` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'N' COMMENT '是否支持图片',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '模型状态',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI模型表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for sys_conference_room
-- ----------------------------
DROP TABLE IF EXISTS `sys_conference_room`;
CREATE TABLE `sys_conference_room`  (
  `room_id` bigint NOT NULL AUTO_INCREMENT COMMENT '会议室ID',
  `room_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '会议室名称',
  `capacity` int NOT NULL COMMENT '容纳人数',
  `location` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '会议室位置',
  `equipment` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '会议设备',
  `dept_id` bigint NULL DEFAULT NULL COMMENT '管理部门ID',
  `admin_id` bigint NULL DEFAULT NULL COMMENT '管理员ID',
  `tags` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '标签',
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '会议室信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for sys_conference_room_layout
-- ----------------------------
DROP TABLE IF EXISTS `sys_conference_room_layout`;
CREATE TABLE `sys_conference_room_layout`  (
  `layout_id` bigint NOT NULL AUTO_INCREMENT COMMENT '布局ID',
  `room_id` bigint NOT NULL COMMENT '会议室ID',
  `config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '布局配置（JSON格式）',
  `seats` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '座位布局（JSON格式）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  CONSTRAINT `sys_conference_room_layout_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `sys_conference_room` (`room_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '会议室布局表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_meeting`  (
  ...
  `meeting_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '会议名称',
  `dept_id` bigint NULL DEFAULT NULL COMMENT '组织部门ID',
  `main_room_id` bigint NULL DEFAULT NULL COMMENT '主会场会议室ID',
  `start_time` datetime NOT NULL COMMENT '会议开始时间',
  `duration` int NOT NULL COMMENT '会议时长（分钟）',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '会议状态（0草稿 1待审核 2已通过 3进行中 4已结束）',
  ...
  `update_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `sub_rooms` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '分会场会议室ID列表（逗号分隔）',
  PRIMARY KEY (`meeting_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '会议信息表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 318 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
